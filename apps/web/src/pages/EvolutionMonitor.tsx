      ...
      <div className="flex-1 min-h-0 relative">
        <div className="absolute inset-0 p-6 overflow-hidden">
          <div className="grid grid-cols-12 gap-6 h-full">
            {/* Left Sidebar - Fitness Overview */}
            <div className="col-span-2 flex flex-col gap-4 h-full overflow-y-auto pb-4 custom-scrollbar">
              <Card>
                <div className="flex items-center gap-2 mb-4">
                  <FontAwesomeIcon icon={faGaugeHigh} className="text-primary-500" />
                  <span className="text-sm font-semibold text-slate-900 dark:text-white">FITNESS OVERVIEW</span>
                </div>
              ...
              <Card>
                ...
                <p className="text-xs text-slate-500 mt-2">Generational Progress</p>
            ...
            <div className="col-span-3 flex flex-col gap-4 h-full overflow-y-auto pb-4 custom-scrollbar">
              <Card>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <FontAwesomeIcon icon={faCodeBranch} className="text-primary-500" />
                    <span className="text-sm font-semibold text-slate-900 dark:text-white">AGENT FLEET</span>
                  </div>
                ...
                <div className="space-y-3">
                  {agents.map((agent, index) => (
                    <div key={agent.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50">
                      ...
                      <span className="text-xs text-slate-400">#{index + 10}-{Math.floor(Math.random() * 90) + 10}</span>
                    </div>
                  ))}
                </div>
              </Card>

              <Button variant="primary" className="w-full" icon={faFlask}>
                VIEW REAL-TIME LOGS
              </Button>
            </div>
          </div>
